...
namespace SmExampleStdCall
{
    public class SmClientStdCall
    {
        ...
        /// </summary>
        const string dllPath = "smClientStdCall.dll";
        ...
        /// <param name="typeCode">Type of memory to open (Integer, Float, Double, String), Use the Enum memoryType</param>
        /// <returns>0 if it runs correctly, 1 if there was an error</returns>
        [DllImport(dllPath, EntryPoint = "createMemory@12", CallingConvention = CallingConvention.StdCall)]
        ...
        /// </summary>
        [DllImport(dllPath, EntryPoint = "freeMemories@0", CallingConvention = CallingConvention.StdCall)]
